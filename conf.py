...
BLOG_AUTHOR = "Levi Gilbert"  # (translatable)
BLOG_TITLE = "Levi Gilbert"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://levigilbert.dev/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://levigilbert.dev/"
BLOG_EMAIL = "levigilbert00@gmail.com"
BLOG_DESCRIPTION = "Games, design, art, etc."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "levigilbert/levigilbert.github.io"
